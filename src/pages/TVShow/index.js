  ...
  return (
    <div className={styles["container-homepage"]}>
      ...
      <div className={styles["slider-content"]}>
        {/* Tổng hợp tất cả bộ TVShow hiện đang thịnh hành*/}
        <h2
          style={{ color: "white" }}
        ...
        {/* Tổng hợp tất cả TVShow hiện có */}
        <h2
          style={{ color: "white" }}
          className={styles["container-news-title"]}
        >
